...
# Load trained model (resolve relative to this file so it works from any cwd).
MODEL_PATH = Path(__file__).resolve().parent / "hacktemple_xgboost_model.pkl"
...
# Allow the Aalayam frontend (and the Vite dev proxy) to call this service.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
